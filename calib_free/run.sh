...
Options:
  ...
  --gpus                        GPU indices (default=0)
  -f, --config_path             Path of config file (required)
  -o, --override_config_path    Path of override config file (optional)
  --output_dir                  Output directory (optional)
  --exp_name                    Experiment name (optional)
  --resume                      Path of checkpoint to resume (optional)
  --start_epoch                 Start epoch (optional)
  --encoder_path                Path of pretrained encoder checkpoint (optional)
  -h, --help                    Print help
EOM
...
function set_options()
{
    arguments=$(getopt --options f:o:h \
                       --longoptions master_port:,gpus:,config_path:,override_config_path:,output_dir:,exp_name:,resume:,start_epoch:,encoder_path:,help \
                       --name $(basename $0) \
                       -- "$@")
...
echo "Run calibration-free PPG-to-BP estimation..."
